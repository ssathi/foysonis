  ...
  $(document).on('click', Selector, function (e) {
      ...
      if (screenfull.enabled) {
        ...
        if(screenfull.isFullscreen)
          $(this).children('em').removeClass('icon-full').addClass('icon-retract');
        else{
          $(this).children('em').removeClass('icon-retract').addClass('icon-full');
        }
...
(function($, window, document){
  ...
  /* Toggle State */
  $(document).on('click', SelectorToggle, sidebarLogo, function (e) {
      e.preventDefault();
...
app.controller('mainCtrl', ['$scope', '$http', '$interval', '$q', function ($scope, $http, $interval, $q) {
  ...
  $scope.gridOptions = {
    ...
    columnDefs: [
      { name: 'Id', width: 130},
      { name: 'Barcode', width: 240},
      { name: 'Travel Seq', width: 240},
      { name: 'Is Blocked?', width: 240},
...
(function($, window, document){
  ...
  $(function() {
    ...
    // $('aside.aside ul.main-nav').mouseenter(function(){
    ...
    navSidebar.on('click', function(e){
        var $bodyClass =  $body.attr('class');

        if ($bodyClass == 'aside-collapsed') {
          $body.removeClass('aside-collapsed');
        } else {
          $body.addClass('aside-collapsed');
        }
  ...
  function adjustLayout() {
    ...
    $('.wrapper > section').css('min-height', $(window).height()-72);
  }

  // Offsidebar
  setTimeout(function(){
    $('.offsidebar').css('display','block');
  }, 2000);
  ...
  mainNavLinks.on('click', function(e){
    var $this = $(this),
        ...
        $thisSiblingLen = $this.next('ul').length;
  ...
  // Responsive Menu
  var menuRes = $('.menu-res'),
      toggleMenu = menuRes.children('.menu-res-toggle'),
      toggleMenuLinks = menuRes.find('a');
  ...
  toggleMenu.on('click', function(){
    ...
    $thisSibling.slideToggle(200);
  });

  toggleMenuLinks.on('click', function(e){
    var $this = $(this),
        $thisSibling = $this.next('ul'),
        $thisSiblingLen = $this.next('ul').length;
