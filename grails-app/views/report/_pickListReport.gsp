    <div class="col-lg-12">
        ...
        <div class="panel panel-default" style="padding: 0px 1px 0 10px;">
            <div class="panel-header"><h4>Pick List Report</h4></div>
            ...
            <div class="panel-footer">
                <div class="pull-right">
                    <button class="btn btn-primary" type="button" ng-click="getPickListReport()">Get Picks Report</button>
                </div>
                <br style="clear: both;"/>
            </div>
        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div>
                 ...
                 <iframe id="pdfReport" style="height:450px; width: 100%;" ng-src="{{ctrl.pickListReportSrcStrg}}"></iframe>
                </div>
            </div>
            <div class="modal-footer">
                ...
                <button type="button" id = "PrintPdf" class="btn btn-primary" ng-click="ctrl.openMailAddrModal(ctrl.pickListReportSrcStrg)">Email</button>
            </div>
        </div>
    </div>
    </div> 
