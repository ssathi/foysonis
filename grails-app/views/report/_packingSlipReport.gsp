    <div class="col-lg-12">
        ...
        <div class="panel panel-default" style="padding: 0px 1px 0 10px;">
            <div class="panel-header"><h4>Packing Slip Report</h4></div>
            ...
            <div class="panel-footer">
                <div class="pull-right">
                    <button class="btn btn-primary" type="button" ng-click="getPackingSlipReport()">Print Packing Slip</button>
                </div>
                <br style="clear: both;"/>
            </div>
        </div>
    ...
    <div id="viewPackingSlipReport" class="modal fade" role="dialog">
    <div class="modal-dialog" style="width:80%">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div>
                 <!-- <embed id="pdfReport" style="height:450px; width: 100%;" ng-src="{{ctrl.packingSlipSrcStrg}}"/> -->
                 <iframe id="pdfReport" style="height:450px; width: 100%;" ng-src="{{ctrl.packingSlipSrcStrg}}"></iframe>
                </div>
            </div>
            <div class="modal-footer">
                ...
                <button type="button" id = "PrintPdf" class="btn btn-primary" ng-click='printReport(ctrl.packingSlipSrcStrg)'>Print</button>
                <button type="button" id = "PrintPdf" class="btn btn-primary" ng-click="ctrl.openMailAddrModal(ctrl.packingSlipSrcStrg)">Email</button>
            </div>
        </div>
    </div>
    </div> 
