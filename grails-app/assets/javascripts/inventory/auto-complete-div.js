(function(){
    ...
    var defaultListFormatter = function(obj, scope) {
        ...
        if (obj[scope.shippingStreetAddressProperty] == undefined) {
            return obj[scope.locationIdProperty];
        }
        else{
            //return obj[scope.locationIdProperty];
            return "<span style='font-size: 15px;'>"+ obj[scope.locationIdProperty] + "</span>"+"<br/><span style='font-weight: normal; font-size: 11px;'>"+obj[scope.shippingStreetAddressProperty]+"</span>";   
        }
    ...
    var addListElements = function(scope, data) {
        ...
        var getLiEl = function(el) {
            var viewValue = typeof el == 'object' ? el[scope.locationIdProperty] : el;
            var modelValue = typeof el == 'object' ? el[scope.locationIdProperty] : el;
