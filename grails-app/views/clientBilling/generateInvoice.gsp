...
<body>
    ...
    <div ng-cloak class="row" id="dvAdminClientBilling" ng-controller="clientBillingCtrl as ctrl">
        ...
        <div class="col-lg-12">
            <div class="col-lg-8">
            <div><em class="fa  fa-fw mr-sm" ><img style="width: 30px; padding-bottom: 10px;" src="/foysonis2016/app/img/invoice_ico50.png"></em>&emsp;&emsp;<span class="headerTitle">Generate Invoice</span></div>
            <br style="clear: both;"/>
            <div class="panel panel-default">
                <div class="panel-heading">
                    <!-- <div class="panel-title mainHeading">Generate Invoice</div> -->
                </div>
                <form name="ctrl.generateInvoiceForm" ng-submit="ctrl.saveBillingInvoice()" novalidate >           
                <div class="panel-body">
                    
                    <div>
                        <div class="col-md-4">
                            <label>Invoice Number</label>
                            <input id="invoiceNumber" name="invoiceNumber" class="form-control" type="text" maxlength="30"  ng-model="ctrl.invoiceData.invoiceNumber" placeholder="Enter Amount" style="width: 250px;" required />
                            ...
                            <div class="form-group" ng-class="{'has-error':ctrl.hasErrorClassOrder('fromDate')}">
                                ...
                                <p class="input-group">
                                    <input type="text" id="fromDate" name="fromDate" class="form-control" uib-datepicker-popup="{{format}}"
                                           ng-model="ctrl.invoiceData.fromDate" is-open="popupFromDate.opened"
                                    ...
                                    <div class="form-group" ng-class="{'has-error':ctrl.hasErrorClassOrder('lateShipDate')}">
                                        ...
                                        <p class="input-group">
                                            <input id="ToDate" name="ToDate" type="text" class="form-control" uib-datepicker-popup="{{format}}"
                                                   ng-model="ctrl.invoiceData.toDate" is-open="popupToDate.opened"
                                                   datepicker-options="dateOptions"  ng-required="true" close-text="Close"
                        ...
                        <!-- <ul class="list-group"> -->
                            <div ng-repeat="billingItem in billingItemData" class="col-md-12 mainItemfield">
                                <div class="form-group">
                                    <div class="col-md-4">
                                        <div ng-init="billingItemData[$index].is_item_selected = true;"></div>
                                        <div class="checkbox c-checkbox">
                                            <label><input id="{{billingItem.id}}" name="{{billingItem.id}}"  type="checkbox" ng-model="billingItemData[$index].is_item_selected" class="itmCheckInput" />
                                            <span class="fa fa-check itmCheckBox"></span>&emsp;{{billingItem.name}}</label> 
                                        </div>
                                    </div>
                                    <div class="col-md-8" ng-if="!disableTextBox[$index]"><input id="{{billingItem.id}}" name="{{billingItem.id}}" class="form-control" type="number" maxlength="30"  ng-model="billingItemData[$index].billing_amount" placeholder="Enter Amount" style="width: 350px;" /></div>
                                    <br style="clear: both;">
                                </div>                                
                                <div ng-init="ctrl.getSubBillingItemData(billingItem.id, $index);"></div>

                                <div ng-if="subBillingItemData.length > 0" class="list-group">
                                    <div class="col-md-12 subItemDiv">
                                        <div ng-repeat="subItem in subBillingItemData[$index]" class="col-md-6">
                                            <div class="form-group">
                                                <div ng-init="subBillingItemData[$parent.$index][$index].is_item_selected = true;"></div>
                                                <div>
                                                       <div class="checkbox c-checkbox">
                                                       <label for="{{subItem.id}}"><input id="{{subItem.id}}" name="{{subItem.id}}"  type="checkbox" ng-model="subBillingItemData[$parent.$index][$index].is_item_selected" class="itmCheckInput"/>
                                                        <span class="fa fa-check itmCheckBox"></span>&emsp;{{subItem.name}}</label>
                                                    </div>
                                                </div>
                                                <div>
                                                    <input id="{{subItem.id}}" name="{{subItem.id}}" class="form-control" type="number" maxlength="30"  ng-model="subBillingItemData[$parent.$index][$index].billing_amount" placeholder="Enter Amount" style="width: 250px;" />
                                                </div>
                                            </div> 
                                        </div>
                                    </div>
...
<!--                                 <div>
                                ...
                                <div ng-repeat="i in ctrl.getNumberLoop(5) track by $index" class="col-md-12">
                                    <div class="form-group">
                                        <div class="col-md-2" style="width: 40px;">
                                            ...
                                            <span class="fa fa-check itmCheckBox"></span></label> 
                                            </div>
                                        </div>
                                        <div class="col-md-4" style="width: 270px">
                                            <input id="customeItemName" name="customeItemName" class="form-control" type="text" maxlength="30"  ng-model="customBillingItem[$index].item_name" placeholder="Enter Item" style="width: 200px;" />
                                        </div>
                ...
                <div class="panel-footer itmfooter">
                    <div >
                        <button type="submit" class="btn btn-primary newFormCreateBtn">
                            <g:message code="default.button.generate.label" />
                        </button>
                    </div>  
                <br style="clear: both;"/>         
                </div>
...
<div id="clientBillingReport" class="modal fade" role="dialog">
