(function(){
  ...
  var defaultListFormatter = function(obj, scope) {
    return '<b>'+obj[scope.firstNameProperty]+'</b>' +
        '&nbsp;' +
        '<b>'+obj[scope.lastNameProperty]+'</b>' +
      '<br><span>'+obj[scope.usernameProperty]+'</span>';
  ...
  var addListElements = function(scope, data) {
    ...
    var getLiEl = function(el) {
      var viewValue = typeof el == 'object' ? el[scope.firstNameProperty] : el;
      var viewValue1 = typeof el == 'object' ? el[scope.lastNameProperty] : el;
      var modelValue = typeof el == 'object' ? el[scope.usernameProperty] : el;
